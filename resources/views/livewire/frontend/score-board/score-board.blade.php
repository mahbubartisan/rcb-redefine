    ...
    <section class="mt-20 lg:mt-8">
        <div class="mx-auto max-w-6xl px-2 sm:px-6 lg:px-4">
            <div>
                ...
                @if ($defaultTab)
                    <div x-ref="tabContent" class="pt-3" x-data="{
                        tab: '{{ $defaultTab }}',
                        scoreSubtab: 'teamA',
                        updateUrl(newTab) {
                        ...
                        scrollToTabTop() {
                            this.$nextTick(() => {
                                this.$refs.tabContent.scrollIntoView({
                                    behavior: 'auto',
                                    block: 'start'
                                });
                            });
                    ...
                    (() => {
                        ...
                        <div class="mx-auto w-full max-w-7xl rounded border border-gray-200 bg-white p-2 lg:p-6">
                            ...
                            <!-- STICKY TABS WRAPPER -->
                            <div class="sticky top-16 z-40 bg-white/95 backdrop-blur-lg transition-shadow duration-300 lg:top-9"
                                    ...
                                    <div class="no-scrollbar overflow-x-auto">
                                        <div class="mx-auto flex min-w-max justify-center gap-8 px-4 py-3">
                                            ...
                                            @if (in_array("summary", $availableTabs))
                                                <button
                                                    class="relative pb-0 text-[15px] font-semibold uppercase tracking-wide transition"
                                                    :class="tab === 'summary'
                                                        ?
                                                        'text-teal-600' :
                                                        'text-gray-700 hover:text-teal-600'"
                                                    @click="tab = 'summary'; updateUrl('summary'); scrollToTabTop();"
                                                    type="button">
                                                    {{ __("messages.summary") }}
                                            ...
                                            @if (in_array("scorecard", $availableTabs))
                                                <button
                                                    ...
                                                    :class="tab === 'scorecard'
                                                        ...
                                                        'text-teal-600' :
                                                        'text-gray-700 hover:text-teal-600'"
                                                    @click="tab = 'scorecard'; scoreSubtab = 'teamA'; updateUrl('scorecard'); scrollToTabTop();"
                                                    type="button">
                                            ...
                                            @if (in_array("squad", $availableTabs))
                                                <button
                                                    ...
                                                    :class="tab === 'squad'
                                                        ...
                                                        'text-teal-600' :
                                                        'text-gray-700 hover:text-teal-600'"
                                                    @click="tab = 'squad'; updateUrl('squad'); scrollToTabTop();"
                                                    type="button">
                                                    {{ __("messages.squad") }}
                                            ...
                                            @if (in_array("matchinfo", $availableTabs))
                                                <button
                                                    ...
                                                    :class="tab === 'matchinfo'
                                                        ...
                                                        'text-teal-600' :
                                                        'text-gray-700 hover:text-teal-600'"
                                                    @click="tab = 'matchinfo'; updateUrl('matchinfo'); scrollToTabTop();"
                                                    type="button">
                                            ...
                                            @if (in_array("overs", $availableTabs))
                                                <button
                                                    ...
                                                    :class="tab === 'overs'
                                                        ...
                                                        'text-teal-600' :
                                                        'text-gray-700 hover:text-teal-600'"
                                                    @click="tab = 'overs'; updateUrl('overs'); scrollToTabTop();"
                                                    type="button">
                                                    {{ __("messages.overs") }}
                                            ...
                                            @if (in_array("headtohead", $availableTabs))
                                                <button
                                                    ...
                                                    :class="tab === 'headtohead'
                                                        ...
                                                        'text-teal-600' :
                                                        'text-gray-700 hover:text-teal-600'"
                                                    @click="tab = 'headtohead'; updateUrl('headtohead'); scrollToTabTop();"
                                                    type="button">
                    ...
                    @if (in_array("scorecard", $availableTabs))
                        <div x-show="tab === 'scorecard'" x-cloak class="text-sm text-gray-700" style="display: none">
                            <!-- Desktop View -->
                            ...
                            <div x-data="{ activeTeam: 0 }" class="block md:hidden">
                                ...
                                <div class="sticky top-[118px] z-30 bg-white pt-3">
                                    <div class="no-scrollbar flex items-center overflow-x-auto rounded-full bg-gray-100">
                                            ...
                                            @foreach ($card["batting"] as $b)
                                                <div class="py-2">
                                                    <div class="flex items-start text-[12px]">
                                                        ...
                                                        <!-- Batsman -->
                                                        <div class="flex min-w-0 flex-1 items-start gap-2 pl-2">
                                                            <img src="{{ asset(optional($b->batter->media)->path ?? "images/user_profile.webp") }}"
                                                                class="h-8 w-8 flex-shrink-0 rounded-full border object-contain">
                    ...
                    @if (in_array("squad", $availableTabs))
                        <div x-show="tab === 'squad'" x-cloak class="text-sm text-gray-700" style="display: none">
                            <!-- Desktop View -->
                                            ...
                                            <div class="overflow-x-auto">
                                                <table class="min-w-full border-collapse text-left">
                                                    <thead class="border-b bg-teal-50 text-sm">
                                                        <tr>
                                                            <th class="min-w-[120px] p-2 font-semibold lg:min-w-0">
                                                                Player
                                                            </th>
                                                            <th
                            ...
                            <div x-data="{ activeTeam: 0 }" class="block md:hidden">
                                ...
                                <div class="sticky top-[118px] z-30 bg-white py-3">
                                    <div class="no-scrollbar flex overflow-x-auto rounded-full bg-gray-100">
                                        @foreach ($match->squads as $index => $squad)
                                            <button @click="activeTeam = {{ $index }}"
                                                class="flex-1 whitespace-nowrap rounded-full px-5 py-2.5 text-[13px] font-semibold transition-all duration-300"
                                                :class="activeTeam === {{ $index }} ?
                                        ...
                                        <div class="overflow-x-auto">
                                            <table class="min-w-full border-collapse text-left">
                                                ...
                                                <tbody class="divide-y divide-gray-200">
                                                    @foreach ($squad->players as $player)
                                                        @php
                                                            $bat = $player->summaryBattingStats[0] ?? [];
                                                            $bowl = $player->summaryBowlingStats[0] ?? [];
                                                        @endphp
                    ...
                    @if (in_array("matchinfo", $availableTabs))
                        <div x-show="tab === 'matchinfo'" x-cloak class="text-sm text-gray-700" style="display: none">
                    ...
                    @if (in_array("overs", $availableTabs))
                        <div x-show="tab === 'overs'" x-cloak class="text-sm text-gray-700" style="display: none">
                                                    ...
                                                    @foreach ($balls->sortByDesc("ball_number") as $comment)
                                                        @php
                                                            ...
                                                            $color = match (true) {
                                                                ...
                                                                $run == 4 => "bg-sky-600 text-white",
                                                                $run == 6 => "bg-indigo-600 text-white",
                                                                in_array($run, [1, 2, 3]) => "bg-lime-600 text-white",
                                                                in_array(strtolower($run), ["nb", "wd", "b1", "l1"])
                                                                    => "bg-amber-600 text-white",
                                                                default => "bg-gray-200 text-gray-900"
                                                            };
                                                        @endphp
                                                        ...
                                                        <div class="flex items-start gap-3 px-3 py-3 text-sm">
                                                            ...
                                                            <!-- Description -->
                                                            <div class="flex-1 text-[13px] leading-snug text-gray-800">
                                                                {{ $description }}
                                                            </div>
                                                        </div>
                                                    @endforeach
                    ...
                    {{-- @if (in_array("headtohead", $availableTabs))
                                    ...
                                    @endif --}}
                    @if (in_array("headtohead", $availableTabs))
                        <div x-show="tab === 'headtohead'" x-cloak class="text-sm text-gray-700" style="display: none">
                                        ...
                                        <div>
                                            <h4
                                                ...
                                                <svg class="h-7 w-7" xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 512 512">
                                                    <path d="" stroke="none" fill="#0d9488" fill-rule="evenodd" />
                                                    <path
                            ...
                            <div class="mx-auto block max-w-xs bg-white text-center md:hidden">
                                ...
                                <div class="mt-5 flex items-center justify-between">
                                    <img src="{{ asset($headToHeadSummary["team1"]["logo"] ?? "images/user_profile.webp") }}"
                                        alt="{{ $headToHeadSummary["team1"]["name"] }}"
                                        class="h-11 w-11 rounded-full object-fill ring-1 ring-gray-200" loading="lazy" />
                                    <div>
