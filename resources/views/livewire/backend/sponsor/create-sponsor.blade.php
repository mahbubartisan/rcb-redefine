    ...
    <div class="my-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="text-[13.5px] text-gray-700 dark:text-gray-300">Create Sponsor</li>
            </ol>
        </nav>
    </div>

    <div class="bg-white dark:bg-[#132337] rounded-md px-6 pt-6 pb-3 shadow">
        <h2 class="text-[15px] text-gray-900 dark:text-gray-300 font-medium mb-4">Sponsor Information</h2>
        <form wire:submit.prevent="store" class="space-y-4">
            <div class="grid grid-cols-2 gap-5 mt-5">
                ...
                <div>
                    ...
                    <input type="text" wire:model="form.title" id="title" placeholder="Enter Sponsor Title"
            ...
            <!-- URL -->
            <div class="mt-5">
                <label for="url" class="block text-sm text-gray-700 dark:text-gray-400">
                    Website
                </label>
                <input type="text" wire:model="form.url" id="url" placeholder="Enter Sponsor Website URL"
                    class="w-full mt-2 px-4 py-3 bg-white dark:bg-[#132337] text-gray-800 dark:text-gray-300 text-sm border border-gray-200 rounded-md dark:border-[#233A57] focus:ring-0 focus:outline-none focus:border-blue-600 transition duration-300 ease-in-out" />
                @error("form.url")
                    <span class="text-red-500 text-xs mt-1">{{ $message }}</span>
                @enderror
