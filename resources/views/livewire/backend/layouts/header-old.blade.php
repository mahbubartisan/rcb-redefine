...
<header
                    ...
                    <a href="{{ route("dashboard") }}">
                        <div class="flex justify-center">
                            <img src="{{ asset(@$setting->siteLogo?->path) }}" alt="{{ @$setting->site_name }}"
                                class="object-fit h-full w-48 flex-shrink-0" />
    ...
    <div class="relative flex items-center gap-x-4">
        ...
        <div class="flex items-center gap-x-4">
            <!-- Today Visitors -->
            <div class="flex items-center space-x-2 border-2 border-dashed border-blue-400 px-2 py-0.5 lg:px-4">
                <p class="text-xs font-medium text-gray-600 dark:text-gray-300 lg:text-sm">Today Visitor:</p>
                <p class="text-xs font-medium text-blue-600 dark:text-blue-600 lg:text-base">
            ...
            <!-- Total Visitors -->
            <div class="flex items-center space-x-2 border-2 border-dashed border-blue-400 px-2 py-0.5 lg:px-4">
                <p class="text-xs font-medium text-gray-600 dark:text-gray-300 lg:text-sm">Total Visitor:</p>
                <p class="text-xs font-medium text-blue-600 dark:text-blue-600 lg:text-base">
                    ...
                    <ul class="mt-4 space-y-3">
                        <li>
                            <a href="{{ route("profile") }}"
                                class="group flex items-center font-[400] text-gray-500 hover:text-blue-500 dark:text-gray-400 dark:hover:text-blue-500">
