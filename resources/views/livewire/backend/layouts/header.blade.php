@php
    ...
    $todayVisitors = App\Models\Visitor::whereDate("visited_date", $today)->distinct("ip_address")->count("ip_address");
...
<header
                    ...
                    <a href="{{ route("dashboard") }}">
                        <div class="flex justify-center">
                            <img src="{{ asset(@$setting->siteLogo?->path) }}" alt="{{ @$setting->site_name }}"
                                class="w-48 h-full object-fit flex-shrink-0" />
                            {{-- <h1 class="text-3xl text-blue-600 font-semibold mt-5">R.C.B</h1> --}}
                        </div>
                    </a>
                </div>
                <!-- Sidebar links -->
                <nav aria-label="Main" class="flex-1 px-2 py-4 space-y-2 overflow-y-hidden hover:overflow-y-auto">
                        ...
                        <div x-data="{ open: {{ request()->routeIs("district", "thana") ? "true" : "false" }} }">
                            ...
                            <div x-show="open" class="mt-2 space-y-2" role="menu" aria-label="Components"
                                ...
                                <ul class="ml-2">
                                    ...
                                    {{ request()->routeIs("district") ? "text-blue-600 dark:text-blue-600" : "text-gray-400 dark:text-gray-100" }}">
                                            <span
                                                class="mr-2 list-disc list-item list-inside text-sm
                                        {{ request()->routeIs("district") ? "text-blue-500" : "text-gray-400 group-hover:text-blue-500" }}">
                                            </span>
                                            <a href="{{ route("district") }}" @click="open = true"
                                                class="flex-grow
                                        {{ request()->routeIs("district") ? "text-blue-600" : "group-hover:text-blue-500" }}">
                                                District
                                            </a>
                                        </li>
                                    @endcanany
                    ...
                    @canany(["view player", "create player", "edit player", "delete player"])
                        <div>
                            <a href="{{ route("player") }}"
                                class="flex items-center space-x-3 p-2 text-sm rounded-md dark:hover:text-blue-600
                        {{ request()->routeIs("player", "create.player", "edit.player") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }}">
                                <span aria-hidden="true">
                    ...
                    @canany(["view team", "create team", "edit team", "delete team"])
                        <div>
                            <a href="{{ route("team") }}"
                                class="flex items-center space-x-3 p-2 text-sm rounded-md dark:hover:text-blue-600
                        {{ request()->routeIs("team", "create.team", "edit.team") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }}">
                                <span aria-hidden="true">
                    ...
                    @canany(["view tournament", "create tournament", "edit tournament", "delete tournament"])
                        <div>
                            <a href="{{ route("tournament") }}"
                                class="flex items-center space-x-3 p-2 text-sm rounded-md dark:hover:text-blue-600
                        {{ request()->routeIs("tournament", "create.tournament", "edit.tournament") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }}">
                                <span aria-hidden="true">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round">
                    ...
                    @canany(["view match", "create match", "edit match", "delete match"])
                        <div>
                            <a href="{{ route("match") }}"
                                class="flex items-center space-x-3 p-2 text-sm rounded-md dark:hover:text-blue-600
                        {{ request()->routeIs("match", "create.match", "edit.match") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }}">
                                <span aria-hidden="true">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg"viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round">
                    ...
                    @canany(["view squad", "create squad", "edit squad", "delete squad"])
                        <div>
                            <a href="{{ route("squad") }}"
                                class="flex items-center space-x-3 p-2 text-sm rounded-md dark:hover:text-blue-600
                        {{ request()->routeIs("squad", "create.squad", "edit.squad") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }}">
                                <span aria-hidden="true">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round">
                    ...
                    @canany(["view score", "create score", "edit score", "delete score"])
                        <div>
                            <a href="{{ route("score") }}"
                                class="flex items-center space-x-3 p-2 text-sm rounded-md dark:hover:text-blue-600
                        {{ request()->routeIs("score", "create.score", "edit.score", "match.result") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }}">
                                <span aria-hidden="true">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round">
                    ...
                    @canany(["view register player", "delete register player"])
                        <div>
                            <a href="{{ route("register-player") }}"
                                class="flex items-center space-x-3 p-2 text-sm rounded-md dark:hover:text-blue-600
                        {{ request()->routeIs("register-player", "view.register-player") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }}">
                                <span aria-hidden="true">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round">
                    ...
                    @canany(["view news", "create news", "edit news", "delete news"])
                        <div>
                            <a href="{{ route("news") }}"
                                class="flex items-center space-x-3 p-2 text-sm rounded-md dark:hover:text-blue-600
                        {{ request()->routeIs("news", "create.news", "edit.news") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }}">
                                <span aria-hidden="true">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round">
                            ...
                            <div x-show="open" class="mt-2 space-y-2" role="menu" aria-label="Components"
                                ...
                                <ul class="ml-2">
                                    ...
                                    @canany(["view gallery", "create gallery", "edit gallery", "delete gallery"])
                                        <li
                                            class="group text-gray-400 text-sm hover:text-blue-500 rounded-md p-2 flex items-center
                                    {{ request()->routeIs("gallery", "create.gallery", "edit.gallery") ? "text-blue-600 dark:text-blue-600" : "text-gray-400 dark:text-gray-100" }}">
                                            <span
                                                class="mr-2 list-disc list-item list-inside text-sm
                                        {{ request()->routeIs("gallery", "create.gallery", "edit.gallery") ? "text-blue-500" : "text-gray-400 group-hover:text-blue-500" }}">
                                            </span>
                                            <a href="{{ route("gallery") }}" @click="open = true"
                                                class="flex-grow
                                        {{ request()->routeIs("gallery", "create.gallery", "edit.gallery") ? "text-blue-600" : "group-hover:text-blue-500" }}">
                                                Photo
                                            </a>
                                        </li>
                                    @endcanany
                                    ...
                                    @canany(["view video", "create video", "edit video", "delete video"])
                                        <li
                                            class="group text-gray-400 text-sm hover:text-blue-500 rounded-md p-2 flex items-center
                                    {{ request()->routeIs("video") ? "text-blue-600 dark:text-blue-600" : "text-gray-400 dark:text-gray-100" }}">
                                            <span
                                                class="mr-2 list-disc list-item list-inside text-sm
                                        {{ request()->routeIs("video") ? "text-blue-500" : "text-gray-400 group-hover:text-blue-500" }}">
                                            </span>
                                            <a href="{{ route("video") }}" @click="open = true"
                                                class="flex-grow
                                        {{ request()->routeIs("video") ? "text-blue-600" : "group-hover:text-blue-500" }}">
                                                Video
                                            </a>
                                        </li>
                                    @endcanany
                    ...
                    @canany(["view faq", "create faq", "edit faq", "delete faq"])
                        <div>
                            <a href="{{ route("faq") }}"
                                class="flex items-center space-x-3 p-2 text-sm rounded-md dark:hover:text-blue-600
                        {{ request()->routeIs("faq", "create.faq", "edit.faq") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }}">
                                <span aria-hidden="true">
                    ...
                    @canany(["view sponsor", "create sponsor", "edit sponsor", "delete sponsor"])
                        <div>
                            <a href="{{ route("sponsor") }}"
                                class="flex items-center space-x-3 p-2 text-sm rounded-md dark:hover:text-blue-600
                        {{ request()->routeIs("sponsor", "create.sponsor", "edit.sponsor") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }}">
                                <span aria-hidden="true">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round">
                            ...
                            <div x-show="open" class="mt-2 space-y-2" role="menu" aria-label="Components"
                                ...
                                <ul class="ml-2">
                                    ...
                                    @canany(["view role icon", "create role icon", "edit role icon", "delete role icon"])
                                        <li
                                            class="group text-gray-400 text-sm hover:text-blue-500 rounded-md p-2 flex items-center
                                                {{ request()->routeIs("role.icon") ? "text-blue-600 dark:text-blue-600" : "text-gray-400 dark:text-gray-100" }}">
                                            <span
                                                class="mr-2 list-disc list-item list-inside text-sm
                                                {{ request()->routeIs("role.icon") ? "text-blue-500" : "text-gray-400 group-hover:text-blue-500" }}">
                                            </span>
                                            <a wire:navigate href="{{ route("role.icon") }}" @click="open = true"
                                                class="flex-grow
                                                {{ request()->routeIs("role.icon") ? "text-blue-600" : "group-hover:text-blue-500" }}">
                                                Role Icon
                                            </a>
                                        </li>
                                    @endcanany
                                    ...
                                    @canany(["view slider", "create slider", "edit slider", "delete slider"])
                                        <li
                                            class="group text-gray-400 text-sm hover:text-blue-500 rounded-md p-2 flex items-center
                                                {{ request()->routeIs("slider", "create.slider", "edit.slider") ? "text-blue-600 dark:text-blue-600" : "text-gray-400 dark:text-gray-100" }}">
                                            <span
                                                class="mr-2 list-disc list-item list-inside text-sm
                                                {{ request()->routeIs("slider", "create.slider", "edit.slider") ? "text-blue-500" : "text-gray-400 group-hover:text-blue-500" }}">
                                            </span>
                                            <a wire:navigate href="{{ route("slider") }}" @click="open = true"
                                                class="flex-grow
                                                {{ request()->routeIs("slider", "create.slider", "edit.slider") ? "text-blue-600" : "group-hover:text-blue-500" }}">
                                                Slider
                                            </a>
                                        </li>
                                    @endcanany
    ...
    <div class="relative flex items-center gap-x-4">
        ...
        <!-- Visitor Stats (hidden on mobile) -->
        <div class="flex items-center gap-x-4">
            <!-- Today Visitors -->
            <div class="flex items-center space-x-2 border-2 border-dashed border-blue-400 px-2 lg:px-4 py-0.5">
                <p class="text-xs lg:text-sm text-gray-600 dark:text-gray-300 font-medium">Today Visitor:</p>
                <p class="text-xs lg:text-base font-medium text-blue-600 dark:text-blue-600">
            ...
            <!-- Total Visitors -->
            <div class="flex items-center space-x-2 border-2 border-dashed border-blue-400 px-2 lg:px-4 py-0.5">
                <p class="text-xs lg:text-sm text-gray-600 dark:text-gray-300 font-medium">Total Visitor:</p>
                <p class="text-xs lg:text-base font-medium text-blue-600 dark:text-blue-600">
