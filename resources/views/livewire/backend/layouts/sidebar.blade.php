...
<!-- Sidebar -->
<aside
    class="w-64 bg-white border-r border-gray-200 hidden lg:flex flex-col dark:bg-[#132337] dark:shadow-2xl dark:border-[#132337] transition-all duration-300 overflow-hidden">
    <!-- Logo and Brand Name -->
    <a href="{{ route("dashboard") }}">
        <div class="flex items-center justify-center ">
            <img src="{{ asset(@$settings->siteLogo?->path ?? "rcb-logo.jpeg") }}" alt="{{ $settings->site_name }}"
                class="h-full w-48 object-fit" />
        </div>
    </a>
    <!-- Sidebar Navigation with Scroll -->
    <nav class="p-4 flex flex-col space-y-4 flex-1 overflow-y-auto">
