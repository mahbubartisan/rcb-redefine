    ...
    <div class="my-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="text-[13.5px] text-gray-700 dark:text-gray-300">Register Players</li>
            </ol>
        </nav>
    </div>
    <!-- Breadcrumb End -->
            ...
            <table
                ...
                <thead class="bg-white dark:bg-[#132337]">
                    <tr>
                        ...
                        @if (auth()->user()->can("view register player") || auth()->user()->can("delete register player"))
                            <th class="px-6 py-3 text-xs text-left font-medium uppercase tracking-wider">
                                Action
                            </th>
                        @endif
                ...
                <tbody class="bg-white dark:bg-[#132337] divide-y divide-gray-200 dark:divide-[#233A57]">
                    @forelse ($players as $index => $player)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">{{ $player->full_name }}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{{ $player->phone }}</td>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center space-x-2">
                                    @can("view register player")
                                        <a href="{{ route("view.register-player", $player->id) }}" title="View">
                                            <!-- View Icon -->
