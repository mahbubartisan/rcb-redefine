    ...
    <div class="my-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="text-[13.5px] text-gray-700 dark:text-gray-300">Edit FAQ</li>
            </ol>
        </nav>
    </div>
        ...
        <form method="post" class="space-y-6">
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="text" wire:model="form.question_en" id="question_en"
                ...
                <div>
                    ...
                    <input type="text" wire:model="form.question_bn" id="question_bn"
