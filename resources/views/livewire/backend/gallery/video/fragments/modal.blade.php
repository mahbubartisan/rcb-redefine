        ...
        <div
            ...
            <div class="flex justify-between items-center p-5 border-b dark:border-gray-700">
                <p class="text-xl dark:text-gray-200">
                    {{ $form->editMode ? "Update" : "Create" }} Video
                </p>
            ...
            <div class="p-5">
                <form wire:submit.prevent="{{ $form->editMode ? "update" : "store" }}" method="POST" class="space-y-3">
                    <!-- Video Code -->
                    <div>
                        <label for="video_code" class="block text-sm text-gray-700 dark:text-gray-400">
                            Video Code<span class="text-red-500">*</span>
                        </label>
                        <input type="text" wire:model='form.video_code' id="video_code"
