    ...
    <div class="my-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="text-[13.5px] text-gray-700 dark:text-gray-300">Edit Gallery</li>
            </ol>
        </nav>
    </div>

    <div class="bg-white dark:bg-[#132337] rounded-md px-6 pt-6 pb-3 shadow">
        <h2 class="text-[15px] text-gray-900 dark:text-gray-300 font-medium mb-4">Gallery Information</h2>
                ...
                <div x-data="{ previewChanging: false }" x-on:livewire-upload-start="previewChanging = true"
                    ...
                    <div
                        ...
                        @if ($form->image)
                            ...
                            @endif
                        @elseif($form->gallery->media?->path)
                            <img src="{{ asset($form->gallery->media?->path) }}" alt="Current Image"
                                class="w-full h-full object-cover transition duration-500"
                                :class="{ 'blur-sm scale-105': previewChanging }" />
                        @else
