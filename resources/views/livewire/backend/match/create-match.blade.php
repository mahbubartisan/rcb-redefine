    ...
    <div class="my-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="text-[13.5px] text-gray-700 dark:text-gray-300">Create Match</li>
            </ol>
        </nav>
    </div>
        ...
        <form method="post" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select wire:model='form.team1Id' id="team1Id" @disabled(empty($form->tournamentId))
                        class="w-full text-sm text-gray-700 border border-gray-200 rounded-md px-4 py-2.5 focus:outline-none focus:border-blue-600 transition duration-300 ease-in-out
                ...
                <div>
                    ...
                    <select wire:model='form.team2Id' id="team2Id" @disabled(empty($form->tournamentId))
                        class="w-full text-sm text-gray-700 border border-gray-200 rounded-md px-4 py-2.5 focus:outline-none focus:border-blue-600 transition duration-300 ease-in-out
                        disabled:bg-gray-100 disabled:cursor-not-allowed disabled:text-gray-500">
                        <option value="">-- Select a Team --</option>
                        @foreach ($form->teams as $team)
