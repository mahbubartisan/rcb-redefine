    ...
    <div class="my-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav>
            <ol class="flex items-center gap-2">
                ...
                <li class="text-[13.5px] text-gray-700 dark:text-gray-300">Create Squad</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <div x-data="{
                        ...
                        initTomSelect() {
                            ...
                            Livewire.on('players-updated', (data) => {
                                ...
                                data.players.forEach(player => {
                                    this.playerSelect.addOption({ value: player.id, text: player.first_name_en });
                                });
                    
                                this.playerSelect.refreshOptions(false);
                                this.playerSelect.clear(); // reset selected
                            });
                        }
                    }" x-init="initTomSelect()" wire:ignore>
                        ...
                        <!-- Empty select, TomSelect will be populated dynamically -->
